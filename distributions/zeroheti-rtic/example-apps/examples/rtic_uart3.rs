...
mod app {
    use bsp::{
        CPU_FREQ_HZ, Interrupt, embedded_io::Write, fugit::ExtU32, mmap::apb_timer::TIMER0_ADDR,
        sprintln, timer_group::Timer, uart::ApbUart,
    };
    ...
    #[init]
    fn init() -> Shared {
        let uart = ApbUart::init(CPU_FREQ_HZ, 115_200);
